<ul class="-mb-px flex w-full border-b border-gray-200">
    <li class="flex-1 cursor-pointer">
        <a class="{{ !request()->routeIs('posts.followed') && !request()->routeIs('posts.category.followed') ? 'border-main text-main' : 'border-transparent hover:border-gray-300 hover:text-gray-600' }} inline-block w-full rounded-t-lg border-b-2 p-4 text-center"
