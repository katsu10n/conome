<div x-data="{ deleteConfirmOpen: false }">
    ...
    <x-common.modal-card-confirm open="deleteConfirmOpen" :action="route('comments.destroy', $comment)" method="DELETE" confirmText="削除する">
